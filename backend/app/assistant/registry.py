...
_ACTIONS: tuple[ActionDefinition, ...] = (
    ...
    _metadata("update_project", ProjectUpdate, ("admin", "hr", "manager"), "high"),
    _metadata("create_contract", ContractCreate, ("admin", "hr", "manager"), "high"),
    _metadata("update_contract", ContractUpdate, ("admin", "hr", "manager"), "high"),
    _metadata("create_document", DocumentCreate, ("admin", "hr", "manager"), "high", execute=kb_service.create_document),
    _metadata("update_document", DocumentUpdate, ("admin", "hr", "manager"), "high", execute=kb_service.update_document),
    ...
    _metadata("generate_payroll", PayrollGenerateIn, ("admin", "finance"), "batch", execute=PayrollService.generate_run),
    _metadata("delete_project", EntityInput, ("admin", "hr", "manager"), "high"),
    _metadata("delete_contract", EntityInput, ("admin", "hr", "manager"), "high"),
    _metadata("delete_document", EntityInput, ("admin", "hr", "manager"), "high", execute=kb_service.delete_document),
